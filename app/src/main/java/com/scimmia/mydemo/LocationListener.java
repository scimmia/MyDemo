    ...
    public void onReceiveLocation(BDLocation location) {
        if (null != location && location.getLocType() != BDLocation.TypeServerError) {
            ...
            FormBody formBody = new FormBody
                    .Builder()
                    .add("ak","Tlod6LwUv3iYIvLGUQr2jQdw")
                    .add("geotable_id","193431")
                    .add("coord_type","3")
                    .add("latitude",""+location.getLatitude())
                    .add("longitude",""+location.getLongitude())
                    .add("title",location.getTime())
                    .add("address",location.getAddrStr())
                    .build();
            new HttpTask("http://api.map.baidu.com/geodata/v3/poi/create","create",formBody).execute();
        }
    }
